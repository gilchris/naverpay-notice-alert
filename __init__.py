...
if os.path.exists(filePath):
    with open(filePath, 'r') as f:
        ...
        # 예전 데이터와 비교해서 동일하면 그냥 종료. 그런데 귀찮기도 하고 맨 위가 다르면 결국 다른 거니까 최상단에 하나만 비표해본다.
        if oldArticles[0]["title"] == currentArticles[0]["title"] and oldArticles[0]["url"] == currentArticles[0]["url"]:
            exit()
